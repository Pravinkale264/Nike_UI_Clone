...
const Hero = () => {
  ...
  return (
    ...
    >
      <div className='relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28 max-lg:pt-10'>
      ...
      xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-cover bg-center '>
        <img src={bigShoeImg} alt="shoeImage" 
        width={610}
        height={500}
        className='object-contain relative z-10 hover:-rotate-12 hover:transition'/>
